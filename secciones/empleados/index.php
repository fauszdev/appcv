            ...
            <table class="table table" id="tabla_id">
                ...
                <tbody>
                    ...
                    <tr class="">
                        ...
                        <td>
                            <a name="btn_crear_carta_empleado" id="btn_crear_carta_empleado" class="btn btn-primary" href="carta_recomendacion.php?txtID=<?php echo $registro['id'];?>" role="button">Carta</a> |
                            ...
                            <a name="btn_eliminar_empleado" id="btn_eliminar_empleado" class="btn btn-danger" href="javascript:borrar(<?php echo $registro['id'];?>);" role="button">Eliminar</a>
                        </td> 
                    </tr>
                    <?php }?>
                </tbody>
